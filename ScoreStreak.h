...
// Класс "Серия очков". Если количество серий очков в системе не меньше "0", то существует возможность вызова метода их атак.
class ScoreStreak
{
private:
	...
	enum { SHIP = '*', NOTHING = '#', HIT = '+', MISS = '-' }; // "Корабль" - "*", "Ничего" - "#", "Попадание" - "+", "Промах" - "-".
public: 
